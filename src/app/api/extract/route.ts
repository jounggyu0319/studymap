...
- **특강·초청강연·대체·보강·휴강·시험 설명(범위 안내)만**인 주는 실질 학습 단원과 무관하면 subtasks에서 **제외**.
- **OT·강의 소개·수업 계획 안내·course overview** 등 행정·안내 성격만 있는 주 → **무조건 제외**.
  - 단, 같은 주에 **실질 강의 주제가 병기**되어 있으면(예: "오리엔테이션 + 유럽의 정체성과 그리스도교") → **포함**.
  - 판단 기준: 주차 설명에 **고유 학습 개념·단원명**이 있으면 포함, **행정·절차·소개 문구만** 있으면 제외.
